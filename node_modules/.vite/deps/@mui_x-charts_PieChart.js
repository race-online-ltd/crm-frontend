import {
  ...
  useYAxis,
  useZAxes
} from "./chunk-OVPBDZUX.js";
import {
  date_default,
  number_default
} from "./chunk-SWZKWGX4.js";
import "./chunk-P5BNCQK4.js";
import "./chunk-UMR3W2D6.js";
import "./chunk-TTGKUZR6.js";
import {
  NoSsr_default
} from "./chunk-DRDEWEGB.js";
import {
  useMediaQuery_default
} from "./chunk-TMCG3OU4.js";
import {
  Typography_default
} from "./chunk-JO3YV4C5.js";
import {
  Popper_default
} from "./chunk-7CCRBXID.js";
import {
  useSlotProps_default
} from "./chunk-QFVGUBHB.js";
import {
  IconButton_default
} from "./chunk-T62ZTBRS.js";
import "./chunk-NW5VI4OH.js";
import {
  HTMLElementType
} from "./chunk-6Q257ZWO.js";
import "./chunk-P6CIYDWM.js";
import {
  useThemeProps
} from "./chunk-OLOE3YNI.js";
import {
  Button_default
} from "./chunk-WPRL5FOQ.js";
import "./chunk-HJNZGEKP.js";
import "./chunk-YHTBL3B6.js";
import "./chunk-5VXJIHFG.js";
import "./chunk-GNM62ZLU.js";
import {
  useLazyRef
} from "./chunk-NMMUNW2M.js";
import "./chunk-X4D6R6B5.js";
import {
  require_react_dom
...
import "./chunk-V6MGU3WH.js";
import "./chunk-ITGWAFDM.js";
import "./chunk-ZCSSBJ3Q.js";
import "./chunk-W2ZGNI6O.js";
import "./chunk-NN3GP43M.js";
import "./chunk-IZT63NOV.js";
import "./chunk-CY455R6Q.js";
import "./chunk-UGVHLCSR.js";
import {
  useEventCallback_default
} from "./chunk-YEKH56VP.js";
import "./chunk-2XVTR6ZR.js";
import "./chunk-PX4W5FJK.js";
import {
  useForkRef
} from "./chunk-3PKW2RKN.js";
import "./chunk-66AIELZT.js";
import "./chunk-XE5GHJTK.js";
import "./chunk-SDGMGCIP.js";
import "./chunk-2EZN23JN.js";
import {
  useTheme
} from "./chunk-RZB3BMJU.js";
import {
  shouldForwardProp,
  styled_default,
  useRtl
} from "./chunk-C6H4TEIZ.js";
...
function ChartsTooltipContainer(inProps) {
  ...
  const pointerAnchorEl = React5.useMemo(() => ({
  ...
  return (0, import_jsx_runtime5.jsxs)(React5.Fragment, {
    children: [svgRef.current && ReactDOM.createPortal((0, import_jsx_runtime5.jsx)("rect", _extends({
      ref: anchorRef
    }, itemPosition, {
      display: "hidden",
      pointerEvents: "none",
      ...
      width: 1,
      height: 1
    })), svgRef.current), (0, import_jsx_runtime5.jsx)(NoSsr_default, {
...
var _excluded5 = ["direction", "onItemClick", "className", "classes", "toggleVisibilityOnClick"];
...
true ? ChartsLegend.propTypes = {
   ...
   * @default false
   */
  toggleVisibilityOnClick: import_prop_types7.default.bool
} : void 0;
...
var PieArc = React13.forwardRef(function PieArc2(props, ref) {
  const {
    className,
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React14.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
var _excluded11 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "skipAnimation", "hidden"];
...
var PieArcLabel = React16.forwardRef(function PieArcLabel2(props, ref) {
  const {
    id,
    classes: innerClasses,
    color,
...
var _excluded15 = ["children", "className", "title", "desc"];
...
var ChartsSlotsContext = React22.createContext(null);
if (true) ChartsSlotsContext.displayName = "ChartsSlotsContext";
function useChartsSlots() {
  const context = React22.useContext(ChartsSlotsContext);
  if (context == null) {
...
function ChartsSlotsProvider(props) {
  ...
  return (0, import_jsx_runtime26.jsx)(ChartsSlotsContext.Provider, {
    value,
    children
  });
}
...
var _excluded16 = ["children", "localeText", "plugins", "seriesConfig", "slots", "slotProps"];
...
function ChartDataProvider(props) {
  ...
  return (0, import_jsx_runtime27.jsx)(ChartProvider, _extends({}, chartProviderProps, {
    children: (0, import_jsx_runtime27.jsx)(ChartsLocalizationProvider, {
      localeText,
      children: (0, import_jsx_runtime27.jsx)(ChartsSlotsProvider, {
        slots,
        slotProps,
...
function useComponentRenderer(defaultElement, render, props, state = {}) {
  ...
  if (render) {
    ...
    return React25.cloneElement(render, props);
  }
  return React25.createElement(defaultElement, props);
}
...
var ToolbarContext = React26.createContext(void 0);
if (true) ToolbarContext.displayName = "ToolbarContext";
function useToolbarContext() {
  const context = React26.useContext(ToolbarContext);
  if (context === void 0) {
...
function ToolbarContextProvider({
  ...
  const [focusableItemId, setFocusableItemId] = React26.useState(null);
  const focusableItemIdRef = React26.useRef(focusableItemId);
  const [items, setItems] = React26.useState([]);
  const getSortedItems = React26.useCallback(() => items.sort(sortByDocumentPosition), [items]);
  const findEnabledItem = React26.useCallback((startIndex, step, wrap = true) => {
  ...
  const registerItem = React26.useCallback((id, itemRef) => {
  ...
  const onItemKeyDown = React26.useCallback((event) => {
    if (!focusableItemId) {
      return;
    }
    const sortedItems = getSortedItems();
  ...
  const onItemFocus = React26.useCallback((id) => {
    if (focusableItemId !== id) {
      setFocusableItemId(id);
    }
  }, [focusableItemId, setFocusableItemId]);
  const onItemDisabled = React26.useCallback((id) => {
    const sortedItems = getSortedItems();
...
function useRegisterToolbarButton(props, ref) {
  ...
  const previousDisabled = React27.useRef(disabled);
  React27.useEffect(() => {
  ...
  const previousAriaDisabled = React27.useRef(ariaDisabled);
  React27.useEffect(() => {
...
var _excluded18 = ["className", "render"];
...
var Toolbar = React28.forwardRef(function Toolbar2(_ref, ref) {
  let {
    className,
    render
...
var _excluded19 = ["render", "onKeyDown", "onFocus", "disabled", "aria-disabled"];
var _excluded23 = ["tabIndex"];
var ToolbarButton = React29.forwardRef(function ToolbarButton2(props, ref) {
  const {
    render
  ...
  return (0, import_jsx_runtime30.jsx)(React29.Fragment, {
    children: element
  });
});
...
function ChartsWrapper(props) {
  ...
  const propsWidth = store.use(selectorChartPropsWidth);
  const propsHeight = store.use(selectorChartPropsHeight);
  return (0, import_jsx_runtime31.jsx)(Root3, {
    ref: chartRootRef,
    ownerState: props,
    sx,
...
true ? ChartsWrapper.propTypes = {
   ...
   */
  extendVertically: import_prop_types20.default.bool,
  /**
   ...
   * @default 'horizontal'
   */
  legendDirection: import_prop_types20.default.oneOf(["horizontal", "vertical"]),
  /**
   * The position of the legend.
   * @default { horizontal: 'center', vertical: 'bottom' }
   */
  legendPosition: import_prop_types20.default.shape({
    horizontal: import_prop_types20.default.oneOf(["center", "end", "start"]),
    vertical: import_prop_types20.default.oneOf(["bottom", "middle", "top"])
  }),
...
var _excluded20 = ["arcLabelRadius"];
function FocusedPieArc(props) {
  ...
  const _getModifiedArcProper = getModifiedArcProperties(series, pieSeriesLayout[focusedItem.seriesId], isHighlighted, isFaded), arcSizes = _objectWithoutPropertiesLoose(_getModifiedArcProper, _excluded20);
  return (0, import_jsx_runtime32.jsx)(PieArc, _extends({
...
var _excluded21 = ["series", "width", "height", "margin", "colors", "sx", "skipAnimation", "hideLegend", "children", "slots", "slotProps", "onItemClick", "loading", "highlightedItem", "onHighlightChange", "className", "showToolbar"];
var PieChart = React32.forwardRef(function PieChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPieChart"
  });
  ...
  return (0, import_jsx_runtime33.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime33.jsxs)(ChartsWrapper, {
      legendPosition: slotProps?.legend?.position,
      legendDirection: slotProps?.legend?.direction ?? "vertical",
      sx,
      hideLegend: hideLegend ?? false,
      children: [showToolbar && Toolbar3 ? (0, import_jsx_runtime33.jsx)(Toolbar3, _extends({}, slotProps?.toolbar)) : null, !hideLegend && (0, import_jsx_runtime33.jsx)(ChartsLegend, {
        direction: slotProps?.legend?.direction ?? "vertical",
        slots,
        slotProps
      }), (0, import_jsx_runtime33.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime33.jsx)(PiePlot, {
          slots,
          slotProps,
          onItemClick
        }), (0, import_jsx_runtime33.jsx)(FocusedPieArc, {}), (0, import_jsx_runtime33.jsx)(ChartsOverlay, {
          loading,
          slots,
          slotProps
        }), children]
      })), !loading && (0, import_jsx_runtime33.jsx)(Tooltip, _extends({
        trigger: "item"
      }, slotProps?.tooltip))]
    })
  }));
...
true ? PieChart.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  apiRef: import_prop_types21.default.shape({
  ...
  enableKeyboardNavigation: import_prop_types21.default.bool,
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
   ...
   * ```
   */
  hiddenItems: import_prop_types21.default.arrayOf(import_prop_types21.default.shape({
    ...
    type: import_prop_types21.default.oneOf(["pie"]).isRequired
  })),
  /**
   * If `true`, the legend is not rendered.
   */
   ...
   * ```
   */
  initialHiddenItems: import_prop_types21.default.arrayOf(import_prop_types21.default.shape({
    dataIndex: import_prop_types21.default.number,
    seriesId: import_prop_types21.default.oneOfType([import_prop_types21.default.number, import_prop_types21.default.string]),
    type: import_prop_types21.default.oneOf(["pie"]).isRequired
  })),
   ...
   */
  onHiddenItemsChange: import_prop_types21.default.func,
  /**
   ...
   */
  onTooltipItemChange: import_prop_types21.default.func,
  /**
  ...
  theme: import_prop_types21.default.oneOf(["dark", "light"]),
  title: import_prop_types21.default.string,
  /**
   * The tooltip item.
   * Used when the tooltip is controlled.
   */
  tooltipItem: import_prop_types21.default.shape({
